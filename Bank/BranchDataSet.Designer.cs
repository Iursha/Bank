...
namespace Bank {
    ...
    public partial class BranchDataSet : global::System.Data.DataSet {
        ...
        public partial class BranchDataTable : global::System.Data.TypedTableBase<BranchRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public BranchRow AddBranchRow(int branch_id, string branch_name, string branch_address, int phone) {
            ...
            private void InitClass() {
                ...
                this.columnbranch_name.MaxLength = 10;
        ...
        public partial class BranchRow : global::System.Data.DataRow {
            ...
            public bool Isbranch_addressNull() {
                return this.IsNull(this.tableBranch.branch_addressColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void Setbranch_addressNull() {
                this[this.tableBranch.branch_addressColumn] = global::System.Convert.DBNull;
            }
...
namespace Bank.BranchDataSetTableAdapters {
    ...
    public partial class BranchTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Branch] WHERE (([branch_id] = @Original_branch_id) AND ((@IsNull_branch_name = 1 AND [branch_name] IS NULL) OR ([branch_name] = @Original_branch_name)) AND ((@IsNull_branch_address = 1 AND [branch_address] IS NULL) OR ([branch_address] = @Original_branch_address)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_branch_address", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "branch_address", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Branch] ([branch_id], [branch_name], [branch_address], [phone]" +
                ") VALUES (@branch_id, @branch_name, @branch_address, @phone);\r\nSELECT branch_id," +
                " branch_name, branch_address, phone FROM Branch WHERE (branch_id = @branch_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Branch] SET [branch_id] = @branch_id, [branch_name] = @branch_name, [branch_address] = @branch_address, [phone] = @phone WHERE (([branch_id] = @Original_branch_id) AND ((@IsNull_branch_name = 1 AND [branch_name] IS NULL) OR ([branch_name] = @Original_branch_name)) AND ((@IsNull_branch_address = 1 AND [branch_address] IS NULL) OR ([branch_address] = @Original_branch_address)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)));
SELECT branch_id, branch_name, branch_address, phone FROM Branch WHERE (branch_id = @branch_id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_branch_address", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "branch_address", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT branch_id, branch_name, branch_address, phone FROM dbo.Branch";
        ...
        public virtual int Fill(BranchDataSet.BranchDataTable dataTable) {
        ...
        public virtual BranchDataSet.BranchDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BranchDataSet.BranchDataTable dataTable = new BranchDataSet.BranchDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BranchDataSet.BranchDataTable dataTable) {
        ...
        public virtual int Delete(int Original_branch_id, string Original_branch_name, string Original_branch_address, global::System.Nullable<int> Original_phone) {
            ...
            if ((Original_branch_address == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_branch_address));
            }
        ...
        public virtual int Insert(int branch_id, string branch_name, string branch_address, global::System.Nullable<int> phone) {
        ...
        public virtual int Update(int branch_id, string branch_name, string branch_address, global::System.Nullable<int> phone, int Original_branch_id, string Original_branch_name, string Original_branch_address, global::System.Nullable<int> Original_phone) {
            ...
            if ((Original_branch_address == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_branch_address));
            }
            if ((Original_phone.HasValue == true)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string branch_name, string branch_address, global::System.Nullable<int> phone, int Original_branch_id, string Original_branch_name, string Original_branch_address, global::System.Nullable<int> Original_phone) {
            return this.Update(Original_branch_id, branch_name, branch_address, phone, Original_branch_id, Original_branch_name, Original_branch_address, Original_phone);
        }
    }
