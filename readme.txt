...
.NET Framework 4.5 
Локальный SQL Server с именем "(local)"
...
При необходимости имя сервера для работы приложения можно изменить в файлах Bank.exe.config и Bank.vshost.exe.config в строке подключения:
